...
import { skillCategories, ProficiencyLevel } from "../data/mockData";
...
export function CreateProjectModal({ isOpen, onClose, onSubmit }: CreateProjectModalProps) {
  ...
  const updateSkillRequirement = (id: string, field: string, value: any) => {
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => updateSkillRequirement(req.id, "proficiencyLevel", e.target.value)}
                              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                          ...
                          <div>
                            ...
                            <select
                              value={req.priority}
                              onChange={(e) => updateSkillRequirement(req.id, "priority", e.target.value)}
                              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              min="1"
                              value={req.count}
                              onChange={(e) => updateSkillRequirement(req.id, "count", parseInt(e.target.value))}
                              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                          </div>
                        </div>
